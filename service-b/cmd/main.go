...
import (
	...
	"github.com/shandler/go-expert-observabilidade/service-b/internal/core/search"
	"github.com/shandler/go-expert-observabilidade/service-b/internal/infra"
...
func main() {
	...
	shutdown, err := shared.InitProvider(viper.GetString("OTEL_SERVICE_NAME"), viper.GetString("OTEL_EXPORTER_OTLP_ENDPOINT"))
	if err != nil {
		log.Fatal(err)
	}
	defer func() {
