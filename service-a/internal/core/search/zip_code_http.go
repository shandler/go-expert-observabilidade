...
import (
	...
	"github.com/shandler/go-expert-observabilidade/service-a/internal/domain"
...
func (z *ZipCodeHttp) Search(ctx context.Context, request dto.SearchRequest) dto.SearchResponse {
	...
	if err := json.NewDecoder(res.Body).Decode(&body); err != nil {
		return z.mountError(res.StatusCode, "Error on decode response service b "+err.Error())
	}

	log.Println("Success response service b response ", body)
